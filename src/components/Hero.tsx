        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-4 mt-4">
            ...
            <ShareButtons 
              ...
              buttonBaseClassName="flex items-center gap-2 bg-gray-50 text-gray-500 px-3 py-1.5 rounded-full text-[11px] font-bold transition-all duration-300 border border-gray-100"
