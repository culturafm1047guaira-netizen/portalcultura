          ...
          <div className="flex items-center gap-4 mt-4">
            ...
            <div className="flex items-center gap-3">
              <button 
                onClick={(e) => {
                  e.preventDefault();
                  window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent(news.title + " " + news.link)}`, "_blank");
                }}
                className="flex items-center gap-2 bg-gray-50 hover:bg-[#25D366]/10 text-gray-500 hover:text-[#25D366] px-3 py-1.5 rounded-full text-[11px] font-bold transition-all duration-300 border border-gray-100"
              >
              ...
              <button 
                onClick={(e) => {
                  e.preventDefault();
                  window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(news.link)}`, "_blank");
                }}
                className="flex items-center gap-2 bg-gray-50 hover:bg-[#1877F2]/10 text-gray-500 hover:text-[#1877F2] px-3 py-1.5 rounded-full text-[11px] font-bold transition-all duration-300 border border-gray-100"
              >
