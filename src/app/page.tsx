      ...
      <main className="container py-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr,320px] gap-8 items-start">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-3 mb-4 pb-2.5 border-b-3 border-esportes-accent">
            ...
            {categories.map((cat) => (
              <React.Fragment key={cat.id}>
                <div className="flex items-center gap-3 mb-4 pb-2.5 border-b-3 border-primary">
                  <h2 className="font-montserrat text-lg font-extrabold text-dark-bg uppercase tracking-wider">
                    {cat.label}
                  </h2>
                  <div className="flex-1 h-px bg-border" />
